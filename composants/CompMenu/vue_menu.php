...
class VueMenu {
    ...
    public function menu($admin){
        ...
        '<li class="nav-item active logo"><a class="nav-link" href="index.php?module=accueil&action=accueil">
            <img id="logo" class"d-inline-block align-top" src="administration/media/logo.png">
            </a></li>' .
        ...
        if (isset($_SESSION['nouvelsession'])){
            ...
            "<li class='nav-item active nav-droite'><a class='nav-link codeco' href=\"index.php?module=co&action=deconnexion\"><h3>Déconnexion</h3></a></li>";
            ...
            if ($admin){
                $this->affichageMenu = $this->affichageMenu .
                "<li class='nav-item active nav-droite'><a class='nav-link' href=\"administration/index.php\"><h3>COTE ADMIN</h3></a>".
                "</ul></div>";
            }
        ...
        //Si l'utilisateur n'est pas connecté => on lui affiche le bouton connexion
            ...
            $this->affichageMenu = $this->affichageMenu .
            "<li class='nav-item active nav-droite'><a class='nav-link codeco' href=\"index.php?module=co&action=connexion\"><h3>Connexion</h3></a></li>".
            "</ul></div>";
        }
    }
}
